...
client = easy_client(
        api_key=secretsExampleTDA.api_key,
        redirect_uri=secretsExampleTDA.redirect_uri,
        token_path=secretsExampleTDA.token_path)
stream_client = StreamClient(client, account_id=secretsExampleTDA.accountID)
